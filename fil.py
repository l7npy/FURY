        ...
        for i in range(818181):
            ...
            if "Available" in isav:
                ...
                try:
                    ...
                    await turbo.send_file(event.chat_id, 'https://t.me/yyyyyy3w/7', caption=f'''Leader : @AbnBashar
User ⤷ @{username}
Save ⤷ ch
turbo ⤷ @g_4_q , @N1FURY
''')
                    await turbo.send_file("i5tbot", 'https://t.me/yyyyyy3w/7', caption=f'''Leader : @AbnBashar
User ⤷ @{username}
Save ⤷ Flod - turbo
Clicks ⤷ {trys}
turbo ⤷ @g_4_q , @N1FURY
